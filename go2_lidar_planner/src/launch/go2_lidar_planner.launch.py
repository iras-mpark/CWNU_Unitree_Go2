...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('min_obstacle_range_m', default_value='0.15'),

        # Planner / follower.
        DeclareLaunchArgument('follow_distance_m', default_value='1.0'),
        DeclareLaunchArgument('grid_resolution_m', default_value='0.1'),
        DeclareLaunchArgument('grid_x_min_m', default_value='0.0'),
        DeclareLaunchArgument('grid_x_max_m', default_value='3.0'),
        DeclareLaunchArgument('grid_y_min_m', default_value='-1.5'),
        DeclareLaunchArgument('grid_y_max_m', default_value='1.5'),
        ...
        DeclareLaunchArgument('max_forward_speed_mps', default_value='3.7'),
        ...
        DeclareLaunchArgument('ttc_emergency_stop_s', default_value='0.55'),
        ...
        DeclareLaunchArgument('turn_slowdown_start_rad', default_value='0.08'),
        DeclareLaunchArgument('turn_speed_limit_heading_rad', default_value='0.25'),
        DeclareLaunchArgument('max_turning_speed_mps', default_value='1.20'),
