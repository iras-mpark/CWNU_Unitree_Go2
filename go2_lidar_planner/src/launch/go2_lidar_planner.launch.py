...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('linear_accel_limit_mps2', default_value='0.7'),
        DeclareLaunchArgument('linear_decel_limit_mps2', default_value='4.0'),
        # Optional LiDAR liveness gate only.  Collision prediction is intentionally
        # not performed in the follower; obstacle avoidance is handled by the
        # obstacle map and A* planner.
