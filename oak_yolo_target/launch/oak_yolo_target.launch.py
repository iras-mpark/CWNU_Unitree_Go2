...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('person_class_id', default_value='0'),
        DeclareLaunchArgument('show_yolo_logs', default_value='false'),

        # Target acquisition / depth robustness.
        DeclareLaunchArgument('auto_acquire', default_value='true'),
        ...
        DeclareLaunchArgument('acquire_center_gate_norm', default_value='1.00'),
        ...
        DeclareLaunchArgument('reacquire_distance_gate_m', default_value='1.0'),
        DeclareLaunchArgument('depth_min_m', default_value='0.25'),
        DeclareLaunchArgument('depth_max_m', default_value='10.0'),
        ...
        DeclareLaunchArgument('min_valid_depth_samples', default_value='20'),
        DeclareLaunchArgument('camera_x_offset_m', default_value='0.0'),
        DeclareLaunchArgument('camera_y_offset_m', default_value='0.0'),
        DeclareLaunchArgument('camera_z_offset_m', default_value='0.0'),
        ...
        # Optional output/debug topics.  Keep every switch explicit in launch.
        # Currently useful RViz topics are enabled by default: compressed image and camera info.
    ...
    node = Node(
        ...
        parameters=[{
            ...
            'person_class_id': ParameterValue(LaunchConfiguration('person_class_id'), value_type=int),
            'show_yolo_logs': ParameterValue(LaunchConfiguration('show_yolo_logs'), value_type=bool),
            'auto_acquire': ParameterValue(LaunchConfiguration('auto_acquire'), value_type=bool),
            'depth_min_m': ParameterValue(LaunchConfiguration('depth_min_m'), value_type=float),
            'depth_max_m': ParameterValue(LaunchConfiguration('depth_max_m'), value_type=float),
            ...
            'min_valid_depth_samples': ParameterValue(LaunchConfiguration('min_valid_depth_samples'), value_type=int),
            'camera_x_offset_m': ParameterValue(LaunchConfiguration('camera_x_offset_m'), value_type=float),
            'camera_y_offset_m': ParameterValue(LaunchConfiguration('camera_y_offset_m'), value_type=float),
            'camera_z_offset_m': ParameterValue(LaunchConfiguration('camera_z_offset_m'), value_type=float),
            ...
            'acquire_center_gate_norm': ParameterValue(LaunchConfiguration('acquire_center_gate_norm'), value_type=float),
            ...
            'reacquire_distance_gate_m': ParameterValue(LaunchConfiguration('reacquire_distance_gate_m'), value_type=float),
